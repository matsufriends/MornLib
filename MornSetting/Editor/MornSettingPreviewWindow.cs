...
namespace MornSetting
{
    ...
    {
        private List<MornSettingBoolSo> _boolSettings = new();
        private List<MornSettingIntSo> _intSettings = new();
        private List<MornSettingFloatSo> _floatSettings = new();
        private List<MornSettingStringSo> _stringSettings = new();
