...
namespace MornLib.Mono
{
    ...
    public class MornImageGizmoMono : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(GetCenterPosition(_image.rectTransform),
                _image.rectTransform.rect.size * _image.rectTransform.lossyScale);
        }
